<template>
  <div>
    ...
    <el-card shadow="never">
      ...
      <el-row>
        <el-col :span="24">
          <el-table :data="carrierlist" ref="multipleTable" style="width: 100%;height: 100%" border :highlight-current-row=true :row-style="{height:'50px'}" :cell-style="{padding:'0'}">
        ...
        <el-form :model="editForm" :rules="addFormRules" ref="editFormRef" label-width="100px" label-position="right" size="mini">
          <el-card shadow="never">
            <el-row :gutter="24">
              <el-col :span="10" :offset="1">
                <el-form-item label="编号" prop="number">
                  <el-input placeholder="自动生成" v-model="editForm.number" :disabled="true">
                  </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="10" :offset="1">
            ...
            <el-row :gutter="24">
              ...
              <el-col :span="10" :offset="1">
                <el-form-item label="单位" prop="unit">
                  <el-cascader v-model="editForm.unit" :options="unitoptions" :show-all-levels="false"></el-cascader>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="24">
            ...
            <el-row :gutter="24">
              <el-col :span="10" :offset="1">
                <el-form-item label="容量" prop="size">
                  <el-input v-model="editForm.size"><template slot="append">G</template></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="10" :offset="1">
                <el-form-item label="颜色" prop="procolor">
                  <el-input v-model="editForm.procolor"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-card>
          <el-card shadow="never" :style="pcmesgshow">
            ...
            <el-row :gutter="24">
              ...
              <el-col :span="10" :offset="1">
                <el-form-item label="硬盘容量" prop="ypsize">
                  <el-input v-model="editForm.ypsize"><template slot="append">G</template></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-card>
